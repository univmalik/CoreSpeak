...
Our primary goal is to provide a seamless vocabulary learning and practice experience. To limit data exposure, we only collect the information strictly necessary to operate the App:

### a. Account Information
When you sign in to Word Love using third-party authentication providers (such as "Sign in with Apple" or Google Sign-In), we collect:
- Your unique user identifier (UID).
- Your display name.
- Your profile picture URL (if provided by the authentication service).

### b. Application Data and Progress
We store your in-app learning progress and preferences so you can access them from any of your devices. This includes:
- Your "Favorites" and saved words in your "Word Jar."
- Timestamps for when words were favorited or learned.
- Spelling practice and quiz states.

### c. Device Information
When you use the App, we securely register your device with our backend. We collect:
...
We use the collected data exclusively to operate and maintain the App:
- **Authentication**: To log you in securely and keep your session active.
- **Cross-Platform Sync**: To synchronize your Word Jar, favorites, and daily word progress instantly across your Apple and Android devices.
- **Premium Access**: To verify your subscription purchases and unlock Premium benefits.
...
We may update our Privacy Policy occasionally. We will notify you of any changes by posting the new Privacy Policy within the App or on this page. You are advised to review this Privacy Policy periodically for any changes.
